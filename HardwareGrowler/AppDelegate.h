...
@interface AppDelegate : NSObject <NSApplicationDelegate, NSToolbarDelegate, NSTableViewDelegate, NSTableViewDataSource, NSWindowDelegate, UNUserNotificationCenterDelegate> {
