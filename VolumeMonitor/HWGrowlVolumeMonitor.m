...
-(NSView*)preferencePane {
	...
	// ExternalDisk/SDCard/USBDrive.
	// Follow-up (29-jul-2026): Optical and NAS now also have their own "-Unmounted"/"-Critical"
	// assets (generated by reusing the same red-X/radioactive-badge overlay already used by
	// the other 3 device types, same canvas/position), closing the gap this comment used to
	// document — HWGDeviceIconNameForCategoryVariant resolves them automatically now that the
	// assets exist, no code change needed beyond adding these rows.
